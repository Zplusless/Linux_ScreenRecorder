# 代码地址 https://segmentfault.com/a/1190000041246061
# 视频编码格式应该为('a', 'v', 'c', '1')，文件后缀为'.mp4'，
# 在录制前先去https://github.com/cisco/open...下下载对应平台的h264文件(openh264-1.8.0-win64.dll for windows)，将压缩包解压放在项目文件夹下。
# 再运行代码，成功会出现一行编码说明：OpenH264 Video Codec provided by Cisco Systems, Inc.
